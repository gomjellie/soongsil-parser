...
class ssu_parser(object):
    ...
    def refresh_notification(self):
        ...
        self.noti_list = [tr.find_all('td')[self.noti_outline].text for tr in soup.tbody.find_all("tr")]
        self.dept_list = [tr.find_all('td')[self.department].text for tr in soup.tbody.find_all("tr")]
        self.date_list = [tr.find_all('td')[self.date].text for tr in soup.tbody.find_all("tr")]
    ...
    def get_notification(self):
        ...
        for dept, noti, date, link in self.my_tb:
            ret += '[{department}] {notification} {date}\n'.format(
